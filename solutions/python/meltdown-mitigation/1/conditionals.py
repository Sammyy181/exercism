...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if temperature < 800 and neutrons_emitted > 500 and temp_neutron_product < 500000:
        return True
    return False
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temp_neutron_product < 0.9 * threshold:
        return 'LOW'
    if temp_neutron_product >= 0.9 * threshold and temp_neutron_product <= 1.1 * threshold:
        return 'NORMAL'
    else:
        return 'DANGER'
